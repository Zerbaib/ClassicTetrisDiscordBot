...
online_version = "https://raw.githubusercontent.com/Zerbaib/ClassicTetrisDiscordBot/main/version"
bot = commands.Bot(intents=disnake.Intents.all(), case_insensitive=True, command_prefix=prefix)
